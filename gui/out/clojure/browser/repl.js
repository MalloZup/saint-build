...
var seq__1887_1891 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1888_1892 = null;
var count__1889_1893 = (0);
var i__1890_1894 = (0);
while(true){
if((i__1890_1894 < count__1889_1893)){
var str_1895 = cljs.core._nth.call(null,chunk__1888_1892,i__1890_1894);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1895})));


var G__1896 = seq__1887_1891;
var G__1897 = chunk__1888_1892;
var G__1898 = count__1889_1893;
var G__1899 = (i__1890_1894 + (1));
seq__1887_1891 = G__1896;
chunk__1888_1892 = G__1897;
count__1889_1893 = G__1898;
i__1890_1894 = G__1899;
continue;
} else {
var temp__5720__auto___1900 = cljs.core.seq.call(null,seq__1887_1891);
if(temp__5720__auto___1900){
var seq__1887_1901__$1 = temp__5720__auto___1900;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1887_1901__$1)){
var c__4550__auto___1902 = cljs.core.chunk_first.call(null,seq__1887_1901__$1);
var G__1903 = cljs.core.chunk_rest.call(null,seq__1887_1901__$1);
var G__1904 = c__4550__auto___1902;
var G__1905 = cljs.core.count.call(null,c__4550__auto___1902);
var G__1906 = (0);
seq__1887_1891 = G__1903;
chunk__1888_1892 = G__1904;
count__1889_1893 = G__1905;
i__1890_1894 = G__1906;
continue;
} else {
var str_1907 = cljs.core.first.call(null,seq__1887_1901__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1907})));


var G__1908 = cljs.core.next.call(null,seq__1887_1901__$1);
var G__1909 = null;
var G__1910 = (0);
var G__1911 = (0);
seq__1887_1891 = G__1908;
chunk__1888_1892 = G__1909;
count__1889_1893 = G__1910;
i__1890_1894 = G__1911;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1916 = script;
goog.object.set(G__1916,"type","text/javascript");

goog.object.set(G__1916,"onload",onload);

goog.object.set(G__1916,"onreadystatechange",onload);

return G__1916;
})();
if((opt_sourceText == null)){
var G__1917 = script__$1;
goog.object.set(G__1917,"src",src);

return G__1917;
} else {
var G__1918 = script__$1;
goog.dom.setTextContext(G__1918,opt_sourceText);
...
var path_1919 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_1919);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1919)].join(''));
} else {
var path_1920 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1920);

goog.object.remove(goog.dependencies_.written,path_1920);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1920)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1921 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1922 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1922;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1921;
}})()})));
});})(connected_QMARK_,repl_connection))
);

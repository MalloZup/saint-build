...
if((i < len)){
var k = (ks[i]);
var G__15244 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__15245 = (i + (1));
m = G__15244;
i = G__15245;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__15247 = c;
var G__15247__$1 = (((G__15247 == null))?null:G__15247.prototype);
if((G__15247__$1 == null)){
return null;
} else {
return (G__15247__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__15249 = c;
var G__15249__$1 = (((G__15249 == null))?null:G__15249.prototype);
if((G__15249__$1 == null)){
return null;
} else {
return (G__15249__$1["render"]);
}
})() == null)))));
});
...
while (G__15253__i < G__15253__a.length) {G__15253__a[G__15253__i] = arguments[G__15253__i + 0]; ++G__15253__i;}
  args = new cljs.core.IndexedSeq(G__15253__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__15256 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15257 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15257;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15256;
}});
...
return ((function (G__15258,G__15258__$1){
...
var c = this;
var G__15263_15265 = (c["cljsRatom"]);
if((G__15263_15265 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__15263_15265);
}
...
var renders_15267 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_15268 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_15267));
if((cljs.core.count.call(null,renders_15267) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_15267))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_15268)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_15268)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__15266 = name;
switch (G__15266) {
case "":
...
var G__15270 = o;
(G__15270[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__15271 = fiber;
var G__15271__$1 = (((G__15271 == null))?null:(G__15271["type"]));
if((G__15271__$1 == null)){
return null;
} else {
return (G__15271__$1["displayName"]);
}
})();
var parent = (function (){var G__15272 = fiber;
if((G__15272 == null)){
return null;
} else {
return (G__15272["return"]);
}
})();
var path = (function (){var G__15273 = parent;
var G__15273__$1 = (((G__15273 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__15273));
if((G__15273__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15273__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__15275 = c;
if((G__15275 == null)){
return null;
} else {
return (G__15275["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__15276._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__15278 = c;
if((G__15278 == null)){
return null;
} else {
return (G__15278["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__15280 = c;
if((G__15280 == null)){
return null;
} else {
return G__15280._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__15282 = instance;
if((G__15282 == null)){
return null;
} else {
return (G__15282["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__15283 = instance;
if((G__15283 == null)){
return null;
} else {
return G__15283._currentElement;
}
}
})();
var name = (function (){var G__15284 = elem;
var G__15284__$1 = (((G__15284 == null))?null:(G__15284["type"]));
if((G__15284__$1 == null)){
return null;
} else {
return (G__15284__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__15286 = elem;
if((G__15286 == null)){
return null;
} else {
return (G__15286["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__15287._owner;
}
}
})();
var path = (function (){var G__15288 = owner;
var G__15288__$1 = (((G__15288 == null))?null:reagent.impl.component.component_path.call(null,G__15288));
if((G__15288__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15288__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__15289 = c;
var G__15289__$1 = (((G__15289 == null))?null:G__15289.constructor);
if((G__15289__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__15289__$1);
}
}
})();

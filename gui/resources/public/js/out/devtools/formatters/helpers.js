...
var G__16751 = devtools.prefs.pref.call(null,v);
v = G__16751;
continue;
} else {
return v;
...
}catch (e16754){var _e__15642__auto__ = e16754;
return false;
}})();
...
}catch (e16758){var _e__15642__auto__ = e16758;
return false;
}})();
...
}catch (e16760){var _e__15642__auto__ = e16760;
return false;
}}
}
});
...
var vec__16762 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16762,(0),null);
var name = cljs.core.nth.call(null,vec__16762,(1),null);
...
return cljs.core.some.call(null,(function (p1__16765_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16765_SHARP_);
}),template);
});

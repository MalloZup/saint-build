...
var o16628 = temp__5733__auto__;
var temp__5733__auto____$1 = (o16628["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o16629 = temp__5733__auto____$1;
return (o16629["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15635__auto__ = f;
return (o__15635__auto__["toString"]).call(o__15635__auto__);
} else {
return "";
}
}catch (e16630){var _ = e16630;
return "";
}});
...
try{var o__15635__auto___16632 = t;
(o__15635__auto___16632["cljs$lang$ctorPrWriter"]).call(o__15635__auto___16632,t,writer);
}catch (e16631){var __16633 = e16631;
}
...
var char_code = (function (){var o__15635__auto__ = (new String(char$));
return (o__15635__auto__["charCodeAt"]).call(o__15635__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15635__auto__ = String;
return (o__15635__auto__["fromCharCode"]).call(o__15635__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16634 = num_code;
switch (G__16634) {
case (1):
return (185);
...
var o__15635__auto__ = String;
return (o__15635__auto__["fromCharCode"]).call(o__15635__auto__,superscript_code);
});
/**
...
}catch (e16636){var _e__15642__auto__ = e16636;
return false;
}})())){
...
var vec__16637 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16637,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o16640 = temp__5733__auto__;
var temp__5733__auto____$1 = (o16640["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o16641 = temp__5733__auto____$1;
return (o16641["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___16648 = arguments.length;
var i__4731__auto___16649 = (0);
while(true){
if((i__4731__auto___16649 < len__4730__auto___16648)){
args__4736__auto__.push((arguments[i__4731__auto___16649]));

var G__16650 = (i__4731__auto___16649 + (1));
i__4731__auto___16649 = G__16650;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16644){
var vec__16645 = p__16644;
var ns_detector = cljs.core.nth.call(null,vec__16645,(0),null);
...
var G__16651 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16652 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16651;
remaining_tokens = G__16652;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16642){
var G__16643 = cljs.core.first.call(null,seq16642);
var seq16642__$1 = cljs.core.next.call(null,seq16642);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16643,seq16642__$1);
});
...
var vec__16656 = cljs.core.split_with.call(null,(function (p1__16655_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16655_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16656,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16656,(1),null);
...
var vec__16662 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16662,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16662,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16665 = cljs.core.rest.call(null,remaining_tokens);
var G__16666 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16665;
name_tokens = G__16666;
continue;
} else {
...
var vec__16669 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16669,(0),null);
var arity = cljs.core.nth.call(null,vec__16669,(1),null);
var vec__16672 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16672,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16672,(1),null);
var vec__16675 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16675,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16675,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16675,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16675,(3),null);
...
var vec__16681 = result;
var munged_ns = cljs.core.nth.call(null,vec__16681,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16681,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16681,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16681,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16681,(4),null);
var arity = cljs.core.nth.call(null,vec__16681,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__16685 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__16685,(0),null);
var args = cljs.core.nth.call(null,vec__16685,(1),null);
var vec__16688 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16688,(0),null);
var name = cljs.core.nth.call(null,vec__16688,(1),null);
...
var G__16691 = (arity + (1));
var G__16692 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16693){
var vec__16694 = p__16693;
var arity = cljs.core.nth.call(null,vec__16694,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16694,(1),null);
...
return cljs.core.get.call(null,arities,p1__16697_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16698_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___16705 = arguments.length;
var i__4731__auto___16706 = (0);
while(true){
if((i__4731__auto___16706 < len__4730__auto___16705)){
args__4736__auto__.push((arguments[i__4731__auto___16706]));

var G__16707 = (i__4731__auto___16706 + (1));
i__4731__auto___16706 = G__16707;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16701){
var vec__16702 = p__16701;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16702,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16699){
var G__16700 = cljs.core.first.call(null,seq16699);
var seq16699__$1 = cljs.core.next.call(null,seq16699);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16700,seq16699__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__16710__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16710__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16710__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16710__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16711 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16711,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16711,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16711,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16711,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16711,(4),null);
var arity = cljs.core.nth.call(null,vec__16711,(5),null);
...
var o__15635__auto__ = f;
return (o__15635__auto__["getBasis"]).call(o__15635__auto__);
});
/**
...
}catch (e16715){var _e__15642__auto__ = e16715;
...
var G__16716 = (obj[cljs.core.first.call(null,path)]);
var G__16717 = cljs.core.rest.call(null,path);
obj = G__16716;
path = G__16717;
continue;
} else {
...
return (function (accum,p__16718){
var vec__16719 = p__16718;
var bit = cljs.core.nth.call(null,vec__16719,(0),null);
var protocol = cljs.core.nth.call(null,vec__16719,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16722){
var vec__16723 = p__16722;
var ns = cljs.core.nth.call(null,vec__16723,(0),null);
var name = cljs.core.nth.call(null,vec__16723,(1),null);
var selector = cljs.core.nth.call(null,vec__16723,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16728,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16728,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16728,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16726_SHARP_){
return (obj[cljs.core.first.call(null,p1__16726_SHARP_)]);
});})(name,sorted_matches,vec__16728,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
